...
public class Cart {
	...
	/**
	 * 
	 * @param idProduct is the idProduct field of the Product object in search.
	 * @return The specified Product object if it exists, otherwise returns null.
	 */
	...
	/**
	 * 
	 * @param product is the Product object to add to Cart.
	...
	/**
	 * 
	 * @param product is the Product object to remove from Cart.
	...
	/**
	 * 
	 * @return True if Cart does not contain any Product, otherwise returns false.
	 */
